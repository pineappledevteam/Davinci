            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_dashboard:
                        fragmentManager.beginTransaction().replace(R.id.fragMainContainer, dashboardDisplayFragment).addToBackStack("dashboard fragment").commit();
                        return true;
                    case R.id.navigation_calendar:
                        fragmentManager.beginTransaction().replace(R.id.fragMainContainer, calendarDisplayFragment).addToBackStack("calendar fragment").commit();
                        return true;
                    case R.id.navigation_eclass:
                        fragmentManager.beginTransaction().replace(R.id.fragMainContainer, eClassDisplayFragment).addToBackStack("eClass fragment").commit();
                        return true;
                    case R.id.navigation_clubs:
                        fragmentManager.beginTransaction().replace(R.id.fragMainContainer, clubsDisplayFragment).addToBackStack("clubs fragment").commit();
                        return true;
                    case R.id.navigation_profile:
                        fragmentManager.beginTransaction().replace(R.id.fragMainContainer, profileDisplayFragment).addToBackStack("profile fragment").commit();
                        return true;
                }
            return false;
            }
